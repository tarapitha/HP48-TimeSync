...
::
  ...
  ::
    ...
    ( Linux command line to get the TICKS value for HP48 )
    $ "date +'obase=16;(%s.%4N+62167219200)*8192/1'|bc"
    $ "C"
    DOPKT
...
+	LCHEX	0001D41E89A00000
  ...
  HXS 3 008 bit+  ( #800h added to fix apparent sync error )
